...
AUTH_CHANNEL = int(environ.get("AUTH_CHANNEL", "-1002645335073"))
...
# MongoDB
DATABASE_URI = environ.get("DATABASE_URI", "mongodb+srv://susantpc1232_db_user:MsGk2PTlLnzhh2VQ@cluster0.uqxwqld.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get("DATABASE_NAME", "susant-botz")

# Files index database url
FILES_DATABASE = environ.get("FILES_DATABASE", "mongodb+srv://susantpc1232_db_user:MsGk2PTlLnzhh2VQ@cluster0.uqxwqld.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/OrbinexX_PFP/1342")
VERIFY_IMG = environ.get(
    "VERIFY_IMG", "https://graph.org/file/1669ab9af68eaa62c3ca4.jpg"
)
SHORTENER_API = environ.get("SHORTENER_API", "8a9695fa344490177749b689e4147813e2824834")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "shortloop.site")
SHORTENER_API2 = environ.get(
    "SHORTENER_API2", "8a9695fa344490177749b689e4147813e2824834"
)
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "shortloop.site")
SHORTENER_API3 = environ.get(
    "SHORTENER_API3", "8a9695fa344490177749b689e4147813e2824834"
)
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", "shortloop.site")
