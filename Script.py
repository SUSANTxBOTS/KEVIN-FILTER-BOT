...
<blockquote>🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href="https://t.me/EraMovies_Official">𝑬𝒓𝒂𝒎𝒐𝒗𝒊𝒆𝒔 𝑶𝒇𝒇𝒊𝒄𝒊𝒂𝒍 !!</a></blockquote></b></i>"""
...
<blockquote>🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ :  <a href="https://t.me/EraMovies_Official">𝑬𝒓𝒂𝒎𝒐𝒗𝒊𝒆𝒔 𝑶𝒇𝒇𝒊𝒄𝒊𝒂𝒍 !!</a></b></blockquote>"""

    ABOUT_TEXT = """<blockquote><b>‣ ᴍʏ ɴᴀᴍᴇ : 𝑺𝑼𝑺𝑨𝑵𝑻 𝒙 𝑨𝑼𝑻𝑶𝑭𝑰𝑳𝑻𝑬𝑹
‣ ᴄʀᴇᴀᴛᴏʀ :  <a href="https://t.me/xPrimeHyper">Hyper</a>
‣ ʟɪʙʀᴀʀʏ : ᴘʏʀᴏɢʀᴀᴍ
‣ ʟᴀɴɢᴜᴀɢᴇ : ᴘʏᴛʜᴏɴ
‣ ᴅᴀᴛᴀ ʙᴀsᴇ : ᴍᴏɴɢᴏ ᴅʙ
‣ ʜᴏsᴛᴇᴅ ᴏɴ  :  ᴡᴇʙ
...
If there is an error, ask to owner: @xPrimeHyper"""
