...
<blockquote>🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href="https://t.me/ll_NOBITA_DEFAULTERS_ll"> 𝚴 𝐎 𝐁 𝚰 𝐓 𝚲 🧩</a></blockquote></b></i>"""
...
<blockquote>🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='https://t.me/ll_NOBITA_DEFAULTERS_ll'> 𝚴 𝐎 𝐁 𝚰 𝐓 𝚲 🧩</a></b></blockquote>"""

    ABOUT_TEXT = """<blockquote><b>‣ ᴍʏ ɴᴀᴍᴇ : Jisshu filter bot
‣ ᴄʀᴇᴀᴛᴏʀ : <a href='https://t.me/ll_NOBITA_DEFAULTERS_ll'> 𝚴 𝐎 𝐁 𝚰 𝐓 𝚲 🧩</a>
‣ ʟɪʙʀᴀʀʏ : ᴘʏʀᴏɢʀᴀᴍ
‣ ʟᴀɴɢᴜᴀɢᴇ : ᴘʏᴛʜᴏɴ
‣ ᴅᴀᴛᴀ ʙᴀsᴇ : ᴍᴏɴɢᴏ ᴅʙ
‣ ʜᴏsᴛᴇᴅ ᴏɴ  :  ᴡᴇʙ
...
If there is an error, ask in the support: @NOOneIsMinee</b>"""
...
🆔 ᴜᴘɪ ɪᴅ ➩ <code>abhaysinghchauhan009@ybl</code> 
 
⛽️ ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴀᴄᴛɪᴠᴇ ᴘʟᴀɴ: /myplan

🏷️ <a href='https://t.me/NOBITA_MUSIC_SUPPORT'>ᴘʀᴇᴍɪᴜᴍ ᴘʀᴏᴏꜰ</a>
